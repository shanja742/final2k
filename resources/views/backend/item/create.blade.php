      ...
      <div class="row">
        ...
        <section class="col-lg-12  col-md-12 col-sm-12">
            ...
            <div class="box">
                ...
                @endif
                <form role="form" action="{{ route('product.store_data') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                    <div class="box-body">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="real_price" value="Rs 0000.00" name="real_price">
                                    @error('real_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="price" value="Rs 0000.00" name="price">
                                    @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="code" value="Product " name="code">
                                    @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-7">
                            ...
                            <label for="description">Description</label>
                                <textarea class="form-control" rows="3" placeholder="Enter the description about the item..." name="description" id="description"></textarea>
                            </div>
